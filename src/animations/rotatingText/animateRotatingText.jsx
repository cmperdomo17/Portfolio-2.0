...
export default function AnimateRotatingText({
    ...
    return (
        <div className="text-2xl md:text-3xl leading-8 flex flex-row items-center justify-start font-light overflow-hidden text-white animate-fadeUp" style={{ "--delay": "0.7s" }}>
            <LayoutGroup>
